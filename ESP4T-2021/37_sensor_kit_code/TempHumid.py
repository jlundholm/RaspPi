...
if __name__ == '__main__':
    ...
    DHT_Sensor = Adafruit_DHT.DHT11 #Create a Temperature and Humidity Sensor Object
    try:
        while True: #creates an infinite loop
            humidity, temperature = Adafruit_DHT.read(DHT_Sensor,DHT_Pin) #creates variables from library
            if humidity is not None and temperature is not None: #if statement testing if values are coming
                ...
                print("Sensor Failure") #prints out that the sensor isn't getting any values
